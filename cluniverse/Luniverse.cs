...
namespace cluniverse
{
    public class Luniverse : ICCClientPlugin
    {

        // NOTE: this must be a blockchain name. 
        private const string name = "luniverse";
        ...
        // NOTE: change confirmations expected for Luniverse
        ...
        public bool Run(bool txid, IConfiguration cfg, string secretOverride, HttpClient httpClient, ITxBuilder txBuilder, ref string progressToken, string url, string[] command, out bool inProgress, out string msg, out string link)
        {
            ...
            {
                // luniverse RegisterTransfer gain orderId
                // luniverse CollectCoins amount
                ...
                // NOTE: This url should be obtained from Luniverse RPC, AFAIK
                string rpcUrl = cfg["rpc"];
                if (string.IsNullOrWhiteSpace(rpcUrl))
                {
                    msg = "luniverse.rpc is not set";
                    return false;
                }
                ...
                else
                {
                    ...
                    if (!erc20)
                    {
                        // NOTE: Not sure this route works for Luniverse RPC as well.
                    ...
                    if (!erc20)
                    {
                        ...
                        // NOTE: Must be same Blockchain name as Luniverse
